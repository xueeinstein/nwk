    ...
    if (!fs.existsSync("node_modules")) {
      ...
      var id = 0,
          ...
          ["// this code snippet is generated by program",
           ...
           "  process.stdout.write(['%MODULE%', 'loads success'].join(' '))",
           "} catch(e) {",
           "  process.stderr.write(['%MODULE%', e.message].join('::'));",
           "}"].join(os.EOL);
      ...
      if (testCode.length === 0) {
        ...
        var testjs = path.resolve(__dirname, "../assets/templates/test-addons-build", "test.js");
